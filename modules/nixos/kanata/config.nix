...
with lib;
let
  toKanataPairs = attrs: mapAttrsToList (k: v: "${k} ${toString v}") attrs |> concatStringsSep "\n  ";
    ...
    keyboards.internalKeyboard = {
      ...
      config = ''
        ...
        ${generateLayer cfg.primaryLayer cfg.layers.${cfg.primaryLayer}}
          ...
          ;; Other Layers
        ${
          removeAttrs cfg.layers [ cfg.primaryLayer ] |> mapAttrsToList generateLayer |> concatStringsSep "\n"
        }
      '';
    };
  };
