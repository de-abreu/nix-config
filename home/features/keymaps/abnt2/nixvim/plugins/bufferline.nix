    ...
    in
      lib.optionals cfg.enable (map (m: m // {mode = "n";}) [
        ...
        }
        {
          ...
          action.__raw =
            # lua
            ''function() require("bufferline.commands").pick()'';
        ...
        }
        {
          ...
          action.__raw =
            # lua
            ''function() require("bufferline.cmmands").close_others() end'';
        ...
        }
        {
          ...
          action.__raw =
            # lua
            ''function() require("bufferline.commands").close_in_direction "right"'';
        ...
        }
        {
          ...
          action.__raw =
            # lua
            ''function() require("bufferline.commands").close_in_direction "left"'';
